...
<div id="custom-audio-player">
  <button class="audio-btn" id="toggle-btn">
    <span id="icon">
...
<audio id="audio" src="{{ '/assets/audio/buulbuul-JJJNNN_2_MMAUDIO_master.mp3' | relative_url }}" preload="metadata"></audio>
